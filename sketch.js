var firstPage, secondPage, thirdPage, fourthPage, fifthPage, sixthPage, seventhPage, eighthPage, ninethPage, tenthPage, eleventhPage, twelvethPage;
...
function setup() {
  ...
  ninethPage = new NinethPage;
  tenthPage = new TenthPage;
  eleventhPage = new EleventhPage;
  twelvethPage = new TwelvethPage;
...
function draw() {
  ...
  if (gameState == 42) {
    ...
    eighthPage.display();
    var correctAns = "1";
    if (correctAns === this.input1)
      fill("green");
    else
      fill("red");
    textSize(25);
    text("SORRY! WRONG ANSWER", 250, 430);
  }
  else if (gameState == 49) {
    var correctAns = "2";
    if (correctAns === this.input2)
      fill("green");
    else
      fill("red");
    textSize(25);
  ...
  drawSprites();
  //this should be displayed on the first page but not able to hide on second page;
  /*textSize(30);
   fill(0);
   strokeWeight(1.5);
   stroke(0)
